  ...
  async getProducts(){
    try {
      ...
      products = products.map(item =>{
        const {title,price,eValue,pValue,cValue,lValue} = item.fields;
        const {id} = item.sys;
        const image = item.fields.image.fields.file.url;
        return {title,price,eValue,pValue,cValue,lValue,id,image}
      })
      return products
    } catch (error) {
      console.log(error);
      ...
      <article class="product">
        <div class="img-container">
          ...
          <div class="product-details">
            <h3> This meal contains ${product.eValue} Kcal including : </h3>
            <ul>
              <li> Protein : ${product.pValue}g</li>
              <li> Carbohydrates : ${product.cValue}g</li>
              <li> Lipids : ${product.lValue}g</li>
            </ul>
          </div>
        </div>
        <h3>${product.title}</h3>
